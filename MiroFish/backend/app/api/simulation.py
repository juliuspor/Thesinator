...
INTERVIEW_PROMPT_PREFIX = "Based on your persona, memory, and actions, reply directly in plain text without calling any tools: "
...
def generate_profiles():
    ...
    try:
        ...
        profiles = generator.generate_profiles_from_entities(
            ...
            use_llm=use_llm,
            use_batching=False,  # quick unblock: disable batching in direct runtime endpoint
        )
